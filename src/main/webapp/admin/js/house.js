        ...
        columns:[[
            ...
            {field: 'dis', title: '操作', width: 100,
                formatter: function (value, row, index) {
                    return '<a href="javascript:passhouse('+row.id+')" class="easyui-linkbutton" iconCls="icon-ok">取消审核 &nbsp;</a><a href="javascript:delete(\'+row.id+\')" class="easyui-linkbutton" iconCls="icon-ok">删除</a> ';
                }
            }
